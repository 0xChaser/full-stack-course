...
describe('Contact Controller', () => {
  ...
  describe('createContact', () => {
    ...
    it('should return error if contact with same lastName already exists for user', async () => {
      const contactData = {
        email: 'newcontact@example.com',
        firstName: 'John',
      ...
      const existingContact = { lastName: contactData.lastName, user_id: userId };
    ...
    it('should handle creation errors', async () => {
      ...
      jest.spyOn(Contact.prototype, 'save').mockRejectedValue(new Error(errorMessage));
  ...
  describe('updateContact', () => {
    ...
    it('should return error if updating lastName to existing one', async () => {
      const contactId = 'contact123';
      const updateData = {
        lastName: 'ExistingLastName'
      };
  ...
  describe('deleteContact', () => {
    ...
    it('should handle deletion errors', async () => {
      ...
      const errorMessage = 'Database error';
      jest.spyOn(Contact, 'findOneAndDelete').mockRejectedValue(new Error(errorMessage));
